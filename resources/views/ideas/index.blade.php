    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session()->has('success'))
                <div class="p-4 bg-green-200 text-green-800 border border-green-300 rounded" role="alert">
                    <p><i class='fas fa-check-double fa-fw'></i>&nbsp; {{ session('success') }}</p>
                </div>
            @endif
            <div class="bg-white mt-3 dark:bg-gray-800 shadow-sm sm:rounded-lg">
                @forelse ( $ideas as $idea )
                    <div class="p-6 flex space-x-2">
                        <svg fill="#808080	" width="24px" height="24px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)">
                        ...
                        <div class="flex-1 ml-3">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <small class="ml-2 text-sm text-gray-600 dark:text-gray-100">{{ $idea -> created_at ->format("d/m/Y H:i") }}</small>
                            ...
                            <small class="text-sm text-gray-400 flex mt-3">
                                <svg width="16px" height="16px" viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#808080	" stroke="#808080	" transform="rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>like [#1385]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-259.000000, -760.000000)" fill="#808080	"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M203,620 L207.200006,620 L207.200006,608 L203,608 L203,620 Z M223.924431,611.355 L222.100579,617.89 C221.799228,619.131 220.638976,620 219.302324,620 L209.300009,620 L209.300009,608.021 L211.104962,601.825 C211.274012,600.775 212.223214,600 213.339366,600 C214.587817,600 215.600019,600.964 215.600019,602.153 L215.600019,608 L221.126177,608 C222.97313,608 224.340232,609.641 223.924431,611.355 L223.924431,611.355 Z" id="like-[#1385]"> </path> </g> </g> </g> </g></svg>
                                <span class="ml-3"> {{ $idea->likes }}</span>
                            </small>
                        </div>
                    </div>
                @empty
                    <h2 class="text-xl p-4 dark:text-white">No hay ideas</h2>
                @endforelse
            </div>
        </div>
    </div>
